...
class TestSaleOrderWeight(common.TransactionCase):
    def setUp(self):
        ...
        order_vals = self.sale_order_model.onchange_partner_id(self.partner.id)["value"]
        ...
        line_data = [
            (
                ...
                0,
                {
                    ...
                    "name": "product test 4",
                    "product_uom_qty": 1.0,
                    "product_uom": self.env.ref("product.product_product_4").uom_id.id,
                    "price_unit": self.env.ref("product.product_product_4").lst_price,
                },
            ),
            (
                0,
                0,
                {
                    ...
                    "name": "product test 5",
                    "product_uom_qty": 2.0,
                    "product_uom": self.env.ref("product.product_product_5").uom_id.id,
                    "price_unit": self.env.ref("product.product_product_5").lst_price,
                },
            ),
            (
                0,
                0,
                {
                    ...
                    "price_unit": self.env.ref("product.product_product_3").lst_price,
                },
            ),
        ]
