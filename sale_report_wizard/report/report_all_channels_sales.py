...
class PosSaleReport(models.Model):
    ...
    # Allow sale_report_wizard module to use the report.all.channels.sale 
    # model by adding confirmation_date to it.
    confirmation_date = fields.Datetime(string="Confirmation Date", readonly=True)
    date = fields.Datetime(string="Confirmation Date", readonly=True)
